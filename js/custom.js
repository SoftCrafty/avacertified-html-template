(function ($) {
    ...
    $(document).ready(function () {
        ...
        studentCard()
        function imgAni(){
            const whoWeImage = document.querySelectorAll(".rb_problem .rb_thumb img")
        ...
        function imgAni2(){
            const whoWeImage = document.querySelectorAll(".rb_curriculum .rb_thumb img")
            if(whoWeImage.length > 0){
                gsap.from(whoWeImage, {
                    scrollTrigger: {
                        trigger: ".rb_curriculum",
                        start: "top 80%",
                        toggleActions: "play none none reverse",
                    },
                    width: "0%",
